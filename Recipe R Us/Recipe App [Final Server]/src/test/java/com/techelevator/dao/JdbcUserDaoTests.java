...
import com.techelevator.RecipeRUs.dao.JdbcUserDao;
...
public class JdbcUserDaoTests extends BaseDaoTests {
    ...
    public void findIdByUsername_given_valid_user_returns_user_id() {
        ...
        Assert.assertEquals(USER_1.getUser_id(), actualUserId);
    }
    ...
    public void getUserById_given_valid_user_id_returns_user() {
        User actualUser = sut.getUserById(USER_1.getUser_id());
    ...
    public void create_user_creates_a_user() {
        ...
        newUser.setUser_id(actualUser.getUser_id());
